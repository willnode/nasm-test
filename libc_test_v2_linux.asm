...
section .data
    ...
    urandom_open_fail_msg db "v2 failed to open /dev/urandom", 10
    urandom_open_fail_len equ $ - urandom_open_fail_msg
    urandom_read_fail_msg db "v2 failed to read from /dev/urandom", 10
...
.after_stat:
    ...
    ; --- 3. Test 'open', 'read', 'close' for /dev/urandom ---
    ; --- open ---
    mov qword [libcall_args + 0], urandom_path ; arg 1: path
    mov qword [libcall_args + 8], 0            ; arg 2: O_RDONLY
